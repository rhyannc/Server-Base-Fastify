...
export interface CompaniesRepository {
  ...
  findMany(page: number): Promise<[any[], number]>
  findManyByUserManager(userId: string, page: number): Promise<[Company[], number]>
  searchMany(query: string, page: number): Promise<[any[], number]>
